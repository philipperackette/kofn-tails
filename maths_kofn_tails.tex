...
\end{itemize}
AES-GCM garantit la confidentialité et l'intégrité des données chiffrées :
toute modification est détectée au déchiffrement. Cependant, l'authenticité 
de l'origine des données n'est assurée que pour les signatures Ed25519, 
pas pour les données chiffrées. L'authenticité des clés publiques (RSA et Ed25519)
doit être vérifiée par des canaux sécurisés externes.
