...
\begin{definition}[S-box inverse]
La S-box inverse INVSBOX() est également définie par une table fixe dans le standard FIPS 197. Elle satisfait:
\[
\mathrm{INVSBOX}(\mathrm{SBox}(b)) = b \quad \text{pour tout octet } b
\]
\end{definition}
